    ...
    def handle(self, *args, **options):
        ...
        categories_data = [
            {
                ...
                "subcategories": [
                    ...
                    },
                    {
                        ...
                        "description": "Hauts tendance et intemporels",
                    ...
                    {
                        "name": "Jupes",
                        "description": "Jupes pour tous les styles",
                        "image_url": "https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=800&h=600&fit=crop",
                    },
                    {
                        "name": "Vestes",
                        "description": "Vestes et manteaux élégants",
                ...
                "subcategories": [
                    {
                        ...
                        "image_url": "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=800&h=600&fit=crop",
                    },
                    {
                        "name": "T-Shirts",
                    ...
                    },
                    {
                        ...
                        "description": "Pantalons et jeans pour homme",
                        "image_url": "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&h=600&fit=crop",
                    },
                    {
                        "name": "Pulls",
                        "description": "Pulls et sweats confortables",
                        "image_url": "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=800&h=600&fit=crop",
                    },
                ],
            },
            {
                ...
                "subcategories": [
                    {
                        ...
                        "image_url": "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=800&h=600&fit=crop",
                    },
                    {
                        "name": "Foulards",
                        "description": "Foulards et écharpes",
                        "image_url": "https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=800&h=600&fit=crop",
                    },
                    {
                        "name": "Chaussures",
        ...
        product_templates = {
            "Robes": [
                (
                    "Robe Midi Élégante",
                    "Robe midi parfaite pour les occasions spéciales.",
                ),
        ...
        for category_name, templates in product_templates.items():
            ...
            for idx, (title, description) in enumerate(templates):
                ...
                for i in range(random.randint(2, 3)):
                    ...
                    sizes = (
                        sizes_clothes
                        if category_name not in ["Pantalons", "Pantalons Homme"]
                        else sizes_nums
                    )
                    ...
                    for size in selected_sizes:
                        for color in selected_colors:
                            ...
                            variant = ProductVariant.objects.create(
                                ...
                                price=base_price,
                                compare_at_price=(
                                    int(base_price * 1.3) if has_sale else None
                                ),
