...
class OrderModelTest(TestCase):
    ...
    def test_order_reference_generation(self):
        order2 = Order.objects.create(
            ...
            first_name='Test',
            last_name='User',
            shipping_address={'street': '123 Main St', 'city': 'Test', 'postal_code': '12345', 'country': 'Test'},
...
class PromotionModelTest(TestCase):
    ...
    def test_promotion_creation(self):
        self.assertEqual(str(self.promotion), 'TEST10 - percentage')
