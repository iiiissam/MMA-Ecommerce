...
export default function VariantsPage() {
  ...
  const addImage = () => {
    setFormData((prev) => ({
      ...
      images: [
        ...(prev.images || []),
        { image_url: '', alt_text: '', position: prev.images?.length || 0 },
      ],
    }))
  }
      ...
      <nav className="bg-white shadow-sm border-b border-gray-200">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link
            ...
            className="text-xl font-semibold text-gray-900 hover:text-rose-600 transition flex items-center gap-2"
          >
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8 border border-gray-200">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-900">
                {editingVariant ? 'Modifier' : 'Ajouter'} une Variante
              </h2>
              {!editingVariant && (
            ...
            {bulkMode && !editingVariant && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-blue-800">
                  <strong>Mode Création Multiple:</strong> Entrez plusieurs tailles et/ou couleurs
                  séparées par des virgules. Le système créera automatiquement toutes les
                  combinaisons possibles.
                  <br />
                  <span className="italic">
                    Exemple: Tailles "S,M,L" et Couleurs "Rouge,Bleu" créera 6 variantes (S-Rouge,
                    S-Bleu, M-Rouge, M-Bleu, L-Rouge, L-Bleu)
                  </span>
                </p>
              </div>
            )}
                ...
                {!bulkMode && (
                  <div>
                    <label className="block text-sm font-semibold mb-2 text-gray-900">
                      SKU{' '}
                      {!editingVariant && (
                        <span className="text-gray-500 font-normal">(auto-généré si vide)</span>
                      )}
                    </label>
                    <input
                      type="text"
