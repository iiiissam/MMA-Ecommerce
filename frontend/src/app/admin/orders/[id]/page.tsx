    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <div className="space-y-2 text-gray-700">
              <p>
                <strong className="text-gray-900">Name:</strong> {order.name}
              </p>
              <p>
                <strong className="text-gray-900">Phone:</strong> {order.phone}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 mb-6">
          ...
          <div className="space-y-2 text-gray-700">
            <p>
              <strong className="text-gray-900">Address:</strong> {order.address}
            </p>
            <p>
              <strong className="text-gray-900">Wilaya:</strong> {order.wilaya_name || 'N/A'}
            </p>
            <p>
              <strong className="text-gray-900">Baladiya:</strong> {order.baladiya_name || 'N/A'}
            </p>
          </div>
        </div>
                ...
                order.lines.map((line: any) => (
                  <tr key={line.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {parseFloat(line.price_snapshot).toFixed(2)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {line.quantity}
                    </td>
          ...
          <div className="space-y-3 text-gray-700">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900">
                {parseFloat(order.subtotal).toFixed(2)} {process.env.NEXT_PUBLIC_CURRENCY || 'EUR'}
              </span>
            </div>
            <div className="flex justify-between">
