    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-4xl font-serif font-bold text-gray-900 mb-4">Votre Panier est Vide</h1>
          <p className="text-gray-600 mb-8 text-lg">Ajoutez des articles pour commencer vos achats!</p>
          <Link
            href="/collections"
